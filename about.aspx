<%@ Page Title="" Language="C#" MasterPageFile="~/Eventify.Master" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="Eventify.about" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <center>
        ...
        <p class="text-justify">Ready to take control of your busy schedule and stay organized with ease? Sign up
            for free and join the Eventify community today. Whether you're a busy professional, 
            a parent juggling multiple responsibilities, or someone with a packed social calendar, 
            Eventify is here to help you stay organized and make the most of your time.</p>
                <p class="text-justify">
                    <asp:Button ID="Button1" runat="server" BackColor="#E48465" BorderColor="#E48465" OnClick="Button1_Click" Text="Sign up now" />
                </p>
</div>
            </div>
        </div>
