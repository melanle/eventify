<%@ Page Title="" Language="C#" MasterPageFile="~/loggedin.Master" AutoEventWireup="true" CodeBehind="home1.aspx.cs" Inherits="Eventify.home1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section>
        <center>
            ...
            Add your events on Eventify with confidence. With Eventify, 
            staying organized has never been easier.</p>
                    <img src="images/logo/getstarted.png" />
            </div>
                    <div>
                        <asp:Button ID="calendar_redirect" runat="server" Text="Add Event" CssClass="calendar_redirect" PostBackUrl="~/calendar.aspx" BackColor="#E48465" BorderColor="#E48465"/>
                    </div>
                </div>
            </div>
        </center>
